...
int main(void) {
  ...
  std::cout << "F - toggles between GL_FILL, GL_LINE Polygon Mode" << std::endl;
  std::cout << "S - toggles between showing splat vertices and actual vertices" << std::endl;
  std::cout << "I, J, K, L - Move light source up, left, down, right respectively" << std::endl;
  std::cout << "A , D - Move selected model left and right respectively" << std::endl;
  std::cout << "UP, DOWN Arrow key - Move selected model up and down respectively" << std::endl;
  std::cout << "+, - - Increase, Decrease scale of model respectively" << std::endl;
  std::cout << "0, 1, 2, 3, 4 - Select the model (if we add a model A first, then pressing 0 would select that model) " << std::endl;
  std::cout << "ESC key to end the program" << std::endl;
