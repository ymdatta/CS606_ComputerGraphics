...
int main(void) {
  ...
  c.addModel("plyfiles/floor.ply");
  c.createAndBind();
  c.loadTexs();

  std::cout << std::endl;
  std::cout << underline_on << "Options: " << underline_off << std::endl;
  std::cout << "T - toggles between textures" << std::endl;
  std::cout << "M - toggles between coordinates (spherical, cylindrical, arbitrary) " << std::endl;
